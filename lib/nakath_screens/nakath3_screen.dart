            ...
            child: Column(
              ...
              children: [
                ...
                AuruduTheme.glassContainer(
                  opacity: 0.15,
                  child: const Text(// aurudu udawa
                    'wfm%a,a ui 14 jk wÕyrejdod Èk mQ¾jNd. 9\'32 g isxy, fou< w¿;a wjqreoao Wodfõ\'',
                ...
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset('assets/images/nakath3.png', height: 200, fit: BoxFit.cover),
                  ),
                ),
                const SizedBox(height: 16),
                const Text(
                ...
                Row(
                  ...
                  children: [
                    RoundedWhiteButton(onPressed: () => Navigator.push(context, smoothPageRoute(const Nakath2Screen()))),
                    const SizedBox(width: 12),
                    RoundedRedButton(onPressed: () => Navigator.push(context, smoothPageRoute(const Nakath4Screen()))),
                  ],
                ),
                const SizedBox(height: 20),
              ],
